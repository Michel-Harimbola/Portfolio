...
const HeroSection = () => {
  return (
    ...
    relative overflow-hidden'>
        ...
        <div className="z-40 xl:mb-0 mb-[20%]">
            ...
            <motion.p 
                ...
                className="text-xl md:text-1xl lg:text-2xl text-purple-200 max-w-2xl">
                    ...
                    Odio delectus expedita aspernatur corrupti,
                    accusamus et numquam quidem eos, animi quaerat accusantium incidunt saepe, ducimus totam! 
                    Fugiat quaerat laboriosam optio est!
            </motion.p>
        </div>
        ...
        scene="https://prod.spline.design/8XhWx3JSZKQ3gxDG/scene.splinecode" />
