...
import { FiGithub, FiLinkedin, FiFacebook, FiMenu, FiX, FiLink } from "react-icons/fi";
            ...
            <motion.div
              ...
              <form className="space-y-4">
                <div>
                  ...
                  focus:ring-2 focus:ring-violet-500 focus:border-violet-500 bg-gray-700"
                  />
                </div>
                ...
                <motion.button 
                  ...
                  to-violet-400 hover:from-violet-700 hover:to-purple-700 transition-all 
